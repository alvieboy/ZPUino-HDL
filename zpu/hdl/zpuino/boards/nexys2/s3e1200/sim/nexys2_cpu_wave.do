...
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_i
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_i_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_o
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_r_i
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_t
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_tris_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/gpio_tris_r_i
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/input_mapper_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/output_mapper_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/ppspin_q
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/spp_cap_in
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/spp_cap_out
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/spp_data
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/io/gpio_inst/spp_read
...
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/begin_inst
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/dointerrupt
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/topcode_sel
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/trace_opcode
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/trace_pc
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/trace_sp
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/trace_topofstack
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/trace_topofstackb
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/wb_ack_i
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/wb_adr_o
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/wb_cyc_o
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/wb_dat_i
add wave -noupdate -format Literal /tb_zpuino/top/zpuino/core/wb_dat_o
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/wb_inta_i
add wave -noupdate -format Logic /tb_zpuino/top/zpuino/core/wb_we_o
...
WaveRestoreCursors {{Cursor 1} {1020000 ps} 0} {{Cursor 2} {995916971 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1978331402 ps}
